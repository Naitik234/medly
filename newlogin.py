...
def register():
    ...
    Label(register_screen, width=20, text="Please enter the details below", bg="plum2").pack(pady=20)
    Label(register_screen, text="").pack(pady=100)
    ...
    Button(register_screen, text="Register", width=10, height=1, bg="plum2", command=register_user).pack()
...
def main_account_screen(frmmain):
    ...
    Label(main_screen,text="Select Your Choice",borderwidth=3, relief="solid", bg="plum2", width="300", height="2", font=("Calibri", 13)).pack()
